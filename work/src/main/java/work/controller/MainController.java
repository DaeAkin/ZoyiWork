...
public class MainController extends HttpServlet {
	...
	private Map<String, Object> getAllTranslationWithKey(String[] urls) {
		List<Translation> list = tDao.getAllTranslationWithKey(Integer.parseInt(urls[1]));
		Map<String, Object> resultMap = new HashMap<String, Object>();
	...
	private Map<String, Object> getAllTranslationsWithKeys(String[] urls) {
		Translation tl = tDao.getTranslatioWithOneKeyAndWtihOneLocale(Integer.parseInt(urls[1]), urls[3]);
		Map<String, Object> resultMap = new HashMap<String, Object>();
